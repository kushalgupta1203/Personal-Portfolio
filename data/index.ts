...
export const Skillset = [
  {
    ...
    desc: "Python, R, SQL, C, C++, Object-Oriented Programming (OOPs), Data Structures and Algorithms.",
  ...
  },
  {
    ...
    desc: "NumPy, Pandas, Scikit-Learn, Seaborn, Matplotlib, TensorFlow, Keras, Snscrape, Machine Learning, Data Visualization, NLP, Statistics,  Tableau, Power BI.",
  ...
  },
  {
    ...
    desc: "Git, Google Colab, Excel, MS PowerPoint, POSTMAN, Windows, Linux, HTML, CSS.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
