  ...
  return (
    <div className="pb-20 pt-36 relative">
      ...
      <div className="flex flex-col items-center justify-between relative my-20 z-10 sm:flex-row sm:items-center">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center sm:items-start justify-center mt-[-100px]"> {/* Move upwards by 100px */}
          <TextGenerateEffect
            words="Hello,"
        ...
        <div className="relative w-full max-w-xs lg:max-w-sm xl:max-w-md h-[450px] mt-4 sm:mt-[-35px] sm:ml-[-15px]"> {/* Adjust positioning and size for small devices */}
          <ImagesSlider
            images={['/kushal.png']}
            autoplay={true}
            direction="up"
      ...
      <div className="absolute top-[35px] right-4 z-20 sm:top-[25px] md:top-[8px] lg:top-[8px]"> {/* Move up by 10px on small screens */}
